...
As seen above, a large portion of fusiform gyrus lies outside of the range for TMS application. For the purpose of overcoming the causality limitation some researchers developed mathematical models like Dynamic Causal Modelling<sup>11</sup>.
