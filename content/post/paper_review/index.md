...
<div class = "blue">
When fMRI is coupled with TMS, it is possible to map the brain areas that are involved in a particular task within the cortex. However, with the current technology it is not possible for TMS to reach some regions like fusiform gyrus.
</div>
