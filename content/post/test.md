...
![Figure 1 Illustrates the general design of the studies. Math tests are used as control condition in all experiments.](/post/graph.png)
...
![Figure 2 Depicts the results of the first study. Interim group maintains their motivation over time while No-Interim group loses the motivation.](/post/time.png)
...
![Figure 3 Representation of face-name pair design. Real pictures were used in the study.](/post/stimuli.png)
...
![Figure 4 Shows the results of face-name pair study. Interim group remembered twice as much pairs than No-Interim group in the final test.](/post/results.png)
...
![Saint Jerome Writing-Caravaggio (1605-6)](/post/caravaggio.jpg)
...
![Figure 5 Shows the grade that groups received in Generate and Read conditions. Participants who generated an errorful answer instead of studying the material scored higher in the final test.](/post/figure.png)
