...
![](/post/graph.png)
*Figure 1 Illustrates the general design of the studies. Math tests are used as control condition in all experiments.*
...
![](/post/time.png)
*Figure 2 Depicts the results of the first study. Interim group maintains their motivation over time while No-Interim group loses the motivation.*
...
![](/post/stimuli.png)
*Figure 3 Representation of face-name pair design. Real pictures were used in the study.*
